...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float_to_int_altfp_convert_lsn
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //float_to_int_altfp_convert_lsn
//VALID FILE
...
module float_to_int (
	...
	float_to_int_altfp_convert_lsn	float_to_int_altfp_convert_lsn_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
