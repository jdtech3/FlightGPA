...
//altfp_div CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" OPTIMIZE="SPEED" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
...
//altfp_div_pst CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" FILE_NAME="float_divide.v:a" PIPELINE=6 WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2018:09:12:13:04:09:SJ cbx_altera_syncram_nd_impl 2018:09:12:13:04:09:SJ cbx_altfp_div 2018:09:12:13:04:09:SJ cbx_altsyncram 2018:09:12:13:04:09:SJ cbx_cycloneii 2018:09:12:13:04:09:SJ cbx_lpm_abs 2018:09:12:13:04:09:SJ cbx_lpm_add_sub 2018:09:12:13:04:09:SJ cbx_lpm_compare 2018:09:12:13:04:09:SJ cbx_lpm_decode 2018:09:12:13:04:09:SJ cbx_lpm_divide 2018:09:12:13:04:09:SJ cbx_lpm_mult 2018:09:12:13:04:09:SJ cbx_lpm_mux 2018:09:12:13:04:09:SJ cbx_mgl 2018:09:12:14:15:07:SJ cbx_nadder 2018:09:12:13:04:09:SJ cbx_padd 2018:09:12:13:04:09:SJ cbx_stratix 2018:09:12:13:04:09:SJ cbx_stratixii 2018:09:12:13:04:09:SJ cbx_stratixiii 2018:09:12:13:04:09:SJ cbx_stratixv 2018:09:12:13:04:09:SJ cbx_util_mgl 2018:09:12:13:04:09:SJ  VERSION_END
...
module  float_divide_altfp_div_pst_p2f
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		value_zero_w = {9{1'b0}};
endmodule //float_divide_altfp_div_pst_p2f

//synthesis_resources = altsyncram 1 lpm_add_sub 4 lpm_compare 1 lpm_mult 5 mux21 74 reg 339 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float_divide_altfp_div_a7i
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	float_divide_altfp_div_pst_p2f   altfp_div_pst1
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		result = wire_altfp_div_pst1_result;
endmodule //float_divide_altfp_div_a7i
//VALID FILE
...
module float_divide (
	...
	float_divide_altfp_div_a7i	float_divide_altfp_div_a7i_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL float_divide_bb.v FALSE
