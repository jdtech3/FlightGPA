...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=16 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  fixed_to_float_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fixed_to_float_altbarrel_shift_fof
...
module  fixed_to_float_altpriority_encoder_be8
	...
	fixed_to_float_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
module  fixed_to_float_altpriority_encoder_6v7
	...
	fixed_to_float_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	fixed_to_float_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
module  fixed_to_float_altpriority_encoder_bv7
	...
	fixed_to_float_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
...
module  fixed_to_float_altpriority_encoder_r08
	...
	fixed_to_float_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fixed_to_float_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
module  fixed_to_float_altpriority_encoder_rf8
	...
	fixed_to_float_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
module  fixed_to_float_altpriority_encoder_qb6
	...
	fixed_to_float_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fixed_to_float_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fixed_to_float_altfp_convert_s2o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fixed_to_float_altbarrel_shift_fof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fixed_to_float_altfp_convert_s2o
//VALID FILE
...
module fixed_to_float (
	...
	fixed_to_float_altfp_convert_s2o	fixed_to_float_altfp_convert_s2o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fixed_to_float.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fixed_to_float_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fixed_to_float_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fixed_to_float.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fixed_to_float.cmp FALSE TRUE
